...
Artifact for: **"SBOM Attack Chain Prediction: GNN-based Vulnerability Analysis
for Software Supply Chains"** — FSE 2026 (IVR)

**Author:** Laura Baird, [QAS Lab](https://faculty.uccs.edu/amoin/research/),
...
```bibtex
@inproceedings{baird2026sbom,
  author = {Baird, Laura},
  title = {SBOM Attack Chain Prediction: GNN-based Vulnerability Analysis for Software Supply Chains},
